...
\begin{flushleft}
\chapter{Course Overview and Preface}
...
When constructing a representation, it is advantageous to represent the system in a minimal form without meaningless states.
